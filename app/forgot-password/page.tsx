...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = "/forgot-password/create-new"
  }
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col">
        <div className="p-8 pb-0">
          <div className="inline-flex items-center border border-gray-300 rounded-lg px-4 py-2">
            <Link href="/signin" className="flex items-center text-gray-600 hover:text-gray-800">
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mb-6">Reset your account password and access your personal again.</p>
